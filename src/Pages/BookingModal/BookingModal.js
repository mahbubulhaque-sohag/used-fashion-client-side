...
const BookingModal = ({product,setItem }) => {
    ...
    const handleBooked = (event, product) =>{
        ...
        <div>
            ...
            <div className="modal">
                <div className="modal-box relative">
                    ...
                    <p>Product: <input type="text" defaultValue={name} readOnly className="input input-bordered w-full max-w-xs" /></p>
                    <p>Price: <input type="text" defaultValue={Resell_Price} readOnly  className="input input-bordered w-full max-w-xs" /></p>
                    <p>Buyer Name: <input type="text" defaultValue={user?.displayName} readOnly  className="input input-bordered w-full max-w-xs" /></p>
                    <p>Buyer's Email: <input type="email" defaultValue={user?.email}  className="input input-bordered w-full max-w-xs" /></p>
                    <p>Price: <input type="text" defaultValue={Resell_Price} readOnly  className="input input-bordered w-full max-w-xs" /></p>
